...
/* ── Verified Pexels Guatemala Videos (all 200 OK) ──── */
const HERO_VIDEO = "https://videos.pexels.com/video-files/12901766/12901766-uhd_2560_1440_24fps.mp4";
const CTA_VIDEO  = "https://videos.pexels.com/video-files/15098625/15098625-uhd_2560_1440_24fps.mp4";
...
const steps = [
  { num: "01", icon: Globe,      title: "Crea tu Empresa",          desc: "Registra tu NIT, razón social y régimen fiscal en menos de 5 minutos." },
  { num: "02", icon: Wrench,     title: "Configura tu Operación",   desc: "Importa empleados, plan de cuentas y catálogo de productos." },
    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
          ...
          >
            <Link href="/">
              <FiniTaxLogo
                size={34}
                textSize="text-[17px]"
                className={navScrolled ? "" : "[&_span]:text-white"}
              />
            </Link>
      ...
      <section className="relative flex flex-col items-center justify-center overflow-hidden" style={{ minHeight: "100vh" }}>
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-4 text-center pt-28 pb-12">
          ...
          <div className="animate-fade-in-up flex flex-wrap justify-center gap-4 mb-6" style={{ animationDelay: "0.28s" }}>
            <Link href="/signup">
              <Button
                size="lg"
                className="h-14 px-10 text-base gradient-primary border-0 text-white shadow-xl shadow-indigo-500/30 hover:shadow-2xl hover:shadow-indigo-500/40 hover:scale-[1.04] transition-all duration-300 font-semibold rounded-xl"
              >
                Crear Cuenta Gratis
            ...
            <Link href="/login">
              <Button
                size="lg"
                variant="outline"
                className="h-14 px-10 text-base border-white/20 text-white bg-white/10 hover:bg-white/20 hover:text-white hover:border-white/30 transition-all duration-300 rounded-xl backdrop-blur-sm"
              >
                Iniciar Sesión
              </Button>
            </Link>
        ...
        <div className="animate-fade-in-up relative z-10 w-full max-w-3xl px-6 -mb-24" style={{ animationDelay: "0.38s" }}>
          ...
          <div
            ...
            style={{ background: "rgba(11,11,24,0.9)", backdropFilter: "blur(24px)", boxShadow: "0 40px 80px rgba(0,0,0,0.6)" }}
          >
              ...
              <div className="rounded-xl p-4" style={{ background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.06)" }}>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center gap-1.5 text-[11px] font-semibold text-emerald-400">
                    <TrendingUp className="h-3 w-3" />+18.4% vs 2024
                  </div>
                </div>
        ...
        <div className="relative z-10 mt-28 mb-8 flex flex-col items-center animate-scroll-hint">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Diseñado específicamente para la legislación fiscal guatemalteca — de la primera factura hasta la declaración anual.
            </p>
          </div>
            ...
            {features.map((f) => (
              <div key={f.title} className="group relative rounded-2xl border bg-card p-7 hover-lift card-shine overflow-hidden cursor-default">
                ...
                <div className="relative">
                  ...
                  <div className={`mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br ${f.gradient} text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div className="lg:sticky lg:top-28">
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                Cada tasa, cada régimen y cada fecha límite — actualizado automáticamente según SAT, IGSS y BANGUAT.
              </p>
              <Link href="/signup">
                <Button size="lg" className="gradient-primary border-0 text-white shadow-lg shadow-primary/25 hover:shadow-xl hover:scale-[1.03] transition-all font-semibold rounded-xl">
      ...
      <section className="relative py-32 px-4 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-3xl text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 backdrop-blur-sm px-4 py-2 text-sm mb-8 text-white/60">
            <Sparkles className="h-3.5 w-3.5" />
          ...
          <p className="text-lg max-w-xl mx-auto mb-10 leading-relaxed text-white/50">
            Únete a empresas guatemaltecas que ya gestionan su contabilidad e impuestos con FiniTax.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/signup">
              <Button size="lg" className="h-14 px-10 text-base bg-white text-[#06060f] hover:bg-white/92 font-bold shadow-xl hover:shadow-2xl hover:scale-[1.04] transition-all duration-300 rounded-xl">
                Crear Cuenta Gratis
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
            <Link href="/login">
              <Button size="lg" variant="outline" className="h-14 px-10 text-base border-white/15 bg-white/5 text-white/80 hover:bg-white/10 hover:text-white transition-all rounded-xl">
                Ya Tengo Cuenta
              </Button>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            <div className="md:col-span-1">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Contabilidad e impuestos para empresas guatemaltecas. Cumplimiento SAT garantizado.
              </p>
            </div>
            <div>
